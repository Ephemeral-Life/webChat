...
<body>
	<%
		...
		else
		{
			%>
				<div class="box">
					<form name="form1" id="form1" method="post" action="./do_account_login">
						<table>
							<tr>
							...
							<tr>
								...
								<input type="button" value="注册" style="width: 65px;"
									onclick="javascript:window.location.href='./action/register.jsp'">
								</td>
							</tr>
						</table>
					</form>
